...
class Minmax_Tree:
    ...
    def get_height(self, mygo):
        ...
        height -= 1
        height = max(height, 4)
        height = min(height, 24-mygo.step)
        return height
...
class Direct_Move:
    ...
    def find_ans(self, mygo):
        poss = [(1, 1), (1, 3), (3, 1), (3, 3)]
        if mygo.step == 0:
            return 2, 2
        if mygo.step == 1:
            x, y = 0, 0
